...
{
	/**
	 * NOTE: this constructor validates the values passed via
	 * {@link SRPUtils#validateConstants(java.math.BigInteger,java.math.BigInteger)}
	 * 
	 * @param largePrime
	 *            a very large prime number
	 * @param primitiveRoot
	 *            a primitive root that relates to the prime number.
	 */
	public SRPConstants(BigInteger largePrime, BigInteger primitiveRoot )
	{
		...
		srp6Multiplier_k = BigInteger.valueOf( 3 );
	}
