...
public class AddJinliOrderGPProxy extends AbstractGamePayProxy<AddJinliOrderResultVO> {
	...
	private static final Logger log = LoggerFactory.getLogger(AddJinliOrderGPProxy.class);
	
	@Override
	public String getAction() {
		return GamePayConfig.ACTION_ADD_JINLI_ORDER;
	}
	...
	@Override
	public AddJinliOrderResultVO parseResponse(JSONObject responseJson) {
		if (responseJson == null){
			return null;
		}
		
		AddJinliOrderResultVO result = new AddJinliOrderResultVO();
...
//			result.setApiKey(responseJson.getString("api_key"));
//			result.setOutOrderNo(responseJson.getString("out_order_no"));
//			result.setSubmitTime(responseJson.getString("submit_time"));
			result.setOrderInfo(responseJson.getString("order_info"));
		} catch (JSONException e) {
