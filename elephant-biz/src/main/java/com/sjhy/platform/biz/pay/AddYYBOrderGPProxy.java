 ...
 * <p>修改描述：</p>
 **/
@Service("AddYYBOrderGPProxy")
public class AddYYBOrderGPProxy extends AbstractGamePayProxy<AddYYBOrderResultVO> {

	private static final Logger log = LoggerFactory.getLogger(AddYYBOrderGPProxy.class);
	
	@Override
	public String getAction() {
		return GamePayConfig.ACTION_ADD_YYB_ORDER;
	}
	...
	@Override
	public AddYYBOrderResultVO parseResponse(JSONObject responseJson) {
		if (responseJson==null){
			return null;
		}
		
		AddYYBOrderResultVO result = new AddYYBOrderResultVO();
